...
in pid_nacionalidad int, in pis_activo bit, pid int, in pusuario_creacion int, in pusuario_modificacion int)
...
begin
    ...
    begin
		insert into tbl_propietario(nombre, apellido, documento, direccion, telefono, id_nacionalidad, usuario_creacion, usuario_modificacion)
        values(pnombre, papellido, pdocumento, pdireccion, ptelefono, pid_nacionalidad, pusuario_creacion, pusuario_modificacion);
    end;
