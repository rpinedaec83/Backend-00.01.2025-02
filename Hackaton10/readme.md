...
Utilizar MYSQL para definir las consultas mediante el uso de Objetos de Base de datos relacionales para resolver el problema
...
Se debe crear un StoreProcedure del tipo CRUD para interactuar con la informacion de las tablas
